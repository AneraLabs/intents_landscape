...
def normalise_cowswap(original_doc,type, normalised_doc):
    if type == 'event':
        ...
        normalised_doc['source_token_address'] = normalise_address_if_needed(original_doc['event']['sellToken'])
        normalised_doc['destination_token_address'] = normalise_address_if_needed(original_doc['event']['buyToken'])
