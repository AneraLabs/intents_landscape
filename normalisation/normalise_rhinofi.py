...
def normalise_rhinofi(original_doc, type, normalised_doc) -> dict | None:
    ...
    if type == "event":
        ...
        if original_doc["scraper_event"] == "BridgedDeposit":
        ...
        elif original_doc["scraper_event"] in {
            "BridgedWithdrawal",
            ...
            print(
                f"Unknown event type [{original_doc['scraper_event']}] for rhino.fi "
                f"doc: [{original_doc}]"
            )
            return None
        ...
        if original_doc["tx"]["instruction"] in {"deposit", "deposit_with_id"}:
            ...
            normalised_doc["source_chain"] = original_doc["scraper_originChain"]
            normalised_doc["source_token_address"] = original_doc[
            ...
            normalised_doc["destination_chain"] = original_doc["scraper_originChain"]
            normalised_doc["destination_token_address"] = original_doc[
